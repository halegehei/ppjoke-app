...
public class LoadingDialog extends BaseDialog {
    ...
    /* loaded from: classes.jar:ps/center/views/dialog/loading/LoadingDialog$TimeoutCallBack.class */
    ...
    public LoadingDialog(Context context, long timeout, TimeoutCallBack timeoutCallBack) {
        super(context, R.style.dialogAlphaBack, R.style.dialogAnimation__min__max);
        this.timeout = 8000L;
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [ps.center.views.dialog.loading.LoadingDialog$1] */
    ...
    public void show() {
        ...
        this.timer = new CountDownTimer(this.timeout, 1000L) { // from class: ps.center.views.dialog.loading.LoadingDialog.1
