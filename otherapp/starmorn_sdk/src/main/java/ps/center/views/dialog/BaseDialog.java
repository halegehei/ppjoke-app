...
/* loaded from: classes.jar:ps/center/views/dialog/BaseDialog.class */
public abstract class BaseDialog extends android.app.Dialog {
    private boolean us_close;
    private final int animationStyle;

    /* loaded from: classes.jar:ps/center/views/dialog/BaseDialog$Call.class */
    ...
    public BaseDialog(Context context, int themeResId, int animationStyle, boolean us_close) {
        super(context, themeResId);
        this.us_close = true;
