...
/* loaded from: classes.jar:ps/center/views/dialog/BaseDialogVB.class */
public abstract class BaseDialogVB<T extends ViewBinding> extends android.app.Dialog {
    ...
    /* loaded from: classes.jar:ps/center/views/dialog/BaseDialogVB$Call.class */
    ...
    public BaseDialogVB(Context context, int themeResId, int animationStyle) {
        super(context, themeResId);
        this.us_close = true;
        this.animationStyle = animationStyle;
    }

    public BaseDialogVB(Context context, int themeResId, int animationStyle, boolean us_close) {
        super(context, themeResId);
        this.us_close = true;
