...
/* loaded from: classes.jar:ps/center/update/VersionUpDataDialog.class */
public class VersionUpDataDialog extends BaseDialog {
    ...
    private static final String savePath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath().toString() + "/updateApk/";
    ...
    public VersionUpDataDialog(Context context, boolean isMust, String url, String title, String content) {
        super(context, R.style.dialogBlackBack, 0, true);
        this.MY_PERMISSIONS_REQUEST_READ_CONTACTS = 10001;
        this.mHandler = new Handler(Looper.getMainLooper()) { // from class: ps.center.update.VersionUpDataDialog.2
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case 2:
                        ...
                        Toast.makeText(VersionUpDataDialog.this.context, "正在安装~", Toast.LENGTH_LONG).show();
                        break;
                    case 3:
                        Toast.makeText(VersionUpDataDialog.this.context, "下载失败~", Toast.LENGTH_LONG).show();
                        break;
                }
            }
        };
    ...
    private void downLoadApk(Context context) {
        ...
        new Thread(new Runnable() { // from class: ps.center.update.VersionUpDataDialog.1
            ...
            public void run() {
                try {
                    URL url1 = new URL(VersionUpDataDialog.this.url);
                    ...
                    String apkFile = VersionUpDataDialog.saveFileName;
                    ...
                    while (true) {
                        ...
                        count += numread;
                        int unused = VersionUpDataDialog.progress = (int) ((count / length) * 100.0f);
