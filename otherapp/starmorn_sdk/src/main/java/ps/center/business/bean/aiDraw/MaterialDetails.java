...
/* loaded from: classes.jar:ps/center/business/bean/aiDraw/MaterialDetails.class */
public class MaterialDetails implements Parcelable {
    public String id;
    ...
    public static final Creator<MaterialDetails> CREATOR = new Creator<MaterialDetails>() { // from class: ps.center.business.bean.aiDraw.MaterialDetails.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public MaterialDetails createFromParcel(Parcel in) {
            return new MaterialDetails(in);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public MaterialDetails[] newArray(int size) {
            return new MaterialDetails[size];
        }
    };
    ...
    protected MaterialDetails(Parcel in) {
