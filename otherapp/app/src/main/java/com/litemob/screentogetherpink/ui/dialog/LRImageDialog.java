...
public class LRImageDialog extends BaseDialog {
    ...
    public LRImageDialog(Context context, String title, String str, String str_l, String str_r, Bitmap imageBitmap, Call call) {
    ...
    protected int getLayout() {
        return R.layout.dialog_lr_image;
    }
    ...
    protected void initView() {
        ...
        iv_content.setImageBitmap(imageBitmap);
